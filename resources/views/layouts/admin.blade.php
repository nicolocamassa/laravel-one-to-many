...
<body>
    <div id="app">
        ...
        <div class="row">
            {{-- SIDEBAR --}}
            <div class="col-2">
                <div class="col-md-3 col-lg-2 col-sm-12 ps-5 vh-100 border-end border-solid position-fixed">
            ...
            <div class="col-9">
                <div class="row">
                    <div class="border-solid border-bottom py-4 mx-5">
                        <header class="d-flex justify-content-between">
                            <a href="{{ route('admin.projects.create')}}">
                                <button class="btn btn-primary fw-bold"><i class="fas fa-plus me-1"></i> Add post</button>
                            </a>
